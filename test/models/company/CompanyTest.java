...
public class CompanyTest extends UnitTest {
	...
	public void after_save_with_account_everything_can_be_fetched() {
		...
		String number1 = "1111";
		Account account1 = new Account(number1, Currency.EUR);
		String number2 = "2222";
		Account account2 = new Account(number2, Currency.GBP);
		...
		Account actualAccount = fetchedAccountIterator.next();
		assertThat(actualAccount.number, is(number1));
		assertThat(actualAccount.currency, is(Currency.EUR));

		actualAccount = fetchedAccountIterator.next();
		assertThat(actualAccount.number, is(number2));
		assertThat(actualAccount.currency, is(Currency.GBP));
	}
}
